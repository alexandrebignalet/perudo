...
{% block panel %}
    ...
    {% endif %}
{% endblock %}
", "@WebProfiler/Collector/cache.html.twig", "/Users/alexandrebignalet/Documents/perso/perudo/vendor/symfony/web-profiler-bundle/Resources/views/Collector/cache.html.twig");
    }
}
