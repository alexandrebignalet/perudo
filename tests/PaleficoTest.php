...
class PaleficoTest extends TestCase
{
    public function test_should_enter_in_palefico_mode_when_one_player_reaches_one_remaining_dice(): void
    {
        ...
        // THEN
        $this->assertEquals($game->isPalefico(), true);
    }
    ...
    public function test_should_consider_paco_as_joker(): void
    {
        // GIVEN
        $game = $this->givenAGameInPalefico();
        ...
        // THEN
        $looser = Helper::findCurrentPlayerByName($game, $looserName);
        $this->assertEquals(count($looser->dices()), 0);
    }
    ...
    public function test_should_end_if_no_one_else_should_enter_in_palefico(): void
    {
        ...
        // THEN
        $this->assertEquals($game->isPalefico(), false);
    }
